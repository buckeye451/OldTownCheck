...
const CONFIG = {
  ...
  formspreeId: "YOUR_FORM_ID", // ← Replace with your Formspree form ID (e.g., "xyzabcde")
  visitReasons: [
...
function FormScreen({ onSubmit, onBack }) {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      _subject: `New Visitor Check-In: ${form.firstName} ${form.lastName}`,
    ...
    try {
      ...
      console.log("✅ Visitor check-in sent:", payload);
      setSubmitting(false);
      onSubmit(form);
    } catch (e) {
